...
add_action( 'add_meta_boxes', 'medical_care_unit_metabox' );

if( ! function_exists( 'medical_care_unit_metabox' ) ):
    function medical_care_unit_metabox() {
        
        add_meta_box(
            'twp-custom-metabox',
            esc_html__( 'Single Post Settings', 'medical-care-unit' ),
            'medical_care_unit_post_metafield_callback',
            'post', 
            'normal', 
            'high'
        );
