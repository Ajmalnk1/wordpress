...
if( !function_exists('medical_care_unit_footer_content_widget') ):
    ...
    function medical_care_unit_footer_content_widget(){
        ...
        $medical_care_unit_default = medical_care_unit_get_default_theme_options();
        if (is_active_sidebar('medical-care-unit-footer-widget-0') ||
            is_active_sidebar('medical-care-unit-footer-widget-1') ||
            is_active_sidebar('medical-care-unit-footer-widget-2')):
            $x = 1;
            $footer_sidebar = 0;
            do {
                if ($x == 3 && is_active_sidebar('medical-care-unit-footer-widget-2')) {
                    $footer_sidebar++;
                }
                if ($x == 2 && is_active_sidebar('medical-care-unit-footer-widget-1')) {
                    $footer_sidebar++;
                }
                if ($x == 1 && is_active_sidebar('medical-care-unit-footer-widget-0')) {
                    $footer_sidebar++;
                }
                $x++;
            } while ($x <= 3);
            ...
            <div class="footer-widgetarea">
                <div class="wrapper">
                    <div class="column-row">
                        ...
                        <?php if (is_active_sidebar('medical-care-unit-footer-widget-0')): ?>
                            <div class="column <?php echo 'column-' . absint($footer_sidebar_class); ?> column-sm-12">
                                <?php dynamic_sidebar('medical-care-unit-footer-widget-0'); ?>
                            </div>
                        <?php endif; ?>

                        <?php if (is_active_sidebar('medical-care-unit-footer-widget-1')): ?>
                            <div class="column <?php echo 'column-' . absint($footer_sidebar_class); ?> column-sm-12">
                                <?php dynamic_sidebar('medical-care-unit-footer-widget-1'); ?>
                            </div>
                        <?php endif; ?>

                        <?php if (is_active_sidebar('medical-care-unit-footer-widget-2')): ?>
                            <div class="column <?php echo 'column-' . absint($footer_sidebar_class); ?> column-sm-12">
                                <?php dynamic_sidebar('medical-care-unit-footer-widget-2'); ?>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="footer-credits">
                            ...
                            <div class="footer-copyright">
                                ...
                                echo esc_html__('Copyright ', 'medical-care-unit') . '&copy ' . absint(date('Y')) . ' <a href="' . esc_url(home_url('/')) . '" title="' . esc_attr(get_bloginfo('name', 'display')) . '" ><span>' . esc_html( get_bloginfo( 'name', 'display' ) ) . '. </span></a> ' . esc_html( $footer_copyright_text );
                                    ...
                                    echo '<br>';
                                    echo esc_html__('Theme: ', 'medical-care-unit') . 'Medical Care Unit ' . esc_html__('By ', 'medical-care-unit') . '  <span>' . esc_html__('OMEGA ', 'medical-care-unit') . '</span>';
